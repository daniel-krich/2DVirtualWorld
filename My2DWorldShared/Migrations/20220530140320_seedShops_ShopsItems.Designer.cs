...
namespace My2DWorldShared.Migrations
{
    ...
    [Migration("20220530140320_seedShops_ShopsItems")]
    partial class seedShops_ShopsItems
    {
            ...
            modelBuilder.Entity("My2DWorldShared.DataEntities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Admin = 1,
                            Birthday = new DateTime(2002, 6, 4, 17, 3, 19, 589, DateTimeKind.Local).AddTicks(5527),
                            Cash = 5000,
                            Email = "test@test.com",
                            Exp = 0,
                            EyeColor = 2,
                        ...
                        new
                        {
                            Id = 2,
                            Admin = 0,
                            Birthday = new DateTime(2002, 6, 4, 17, 3, 19, 589, DateTimeKind.Local).AddTicks(5571),
                            Cash = 2340,
